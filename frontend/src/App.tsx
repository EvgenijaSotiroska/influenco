...
import { ForBrandsPage } from "./pages/marketing/ForBrandsPage.tsx";
import { ForCreatorsPage } from "./pages/marketing/ForCreatorsPage.tsx";
import "./App.css";
            ...
            <SnackbarProvider>
                <AuthProvider>
                    <Routes>
                        ...
                        <Route path="/for-brands" element={<Layout><ForBrandsPage /></Layout>} />
                        <Route path="/for-creators" element={<Layout><ForCreatorsPage /></Layout>} />
                        <Route
                            path="/dashboard"
                            element={
                                <ProtectedRoute>
